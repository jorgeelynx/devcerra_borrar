        ...
        'success':function(result){			//console.log(result);            var dataResult = JSON.parse(result);
            setTimeout(function(){
                ...
                if(dataResult["status"] == 0){
                    ...
                    setTimeout(function(){
                        // var button = document.getElementById('cancelAddDb');
                        //button.form.submit();
                        alert("Import Successful");                        $(".ba_load").fadeOut("slow");                        // $("#span_check_auto_import").fadeIn("slow");
                    }, 500);
                    return;
                }
            }, 100);
