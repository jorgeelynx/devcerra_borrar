...
<div class="text-center infinite-box mar_b6 m-t-1">
  <a class="infinite-more-link btn btn-default btn-large {if $sttheme.infinite_scroll==1} hidden {/if}" data-start="{$pagination.items_shown_from}" href="{$page.url}" rel="nofollow">{l s='Load More Products' d='Shop.Theme.Panda'}</a>
</div>
{/if}
{/foreach}
