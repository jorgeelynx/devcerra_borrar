    ...
    {foreach from=$product.extraContent item=extra key=extraKey}
        ...
        {if $extra.moduleName == 'stthemeeditor'}
          {if $sttheme.display_pro_tags==1 && isset($extra.content.tags)}
            <li class="nav-item">
              <a class="nav-link {if !$st_active_pro_tab} active{/if}" data-toggle="tab" role="tab" aria-controls="porudct-tags-tab" data-module="{$extra.moduleName}" href="#porudct-tags-tab">{l s='Tags' d='Shop.Theme.Panda'}</a>
            </li>
